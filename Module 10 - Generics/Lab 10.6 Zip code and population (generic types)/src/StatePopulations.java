 ...
 * 
 * This class program fills 3 ArrayLists with StatePair objects. The program reads in a file to do so.
 * Since each of these arrayLists hold different information, in a series of 3 for loops,the program uses the lists' 
 * information to find which elements correspond to eachother. After using said information, a new StatePair object 
 * is created and its information is printed
 * 
 */
   ...
   public static void main(String[] args) throws IOException {
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
         // TODO: Using ZIP code, find state abbreviation
    	  if (zipCodeState.get(i).getValue1().equals(myZipCode)) {
    		  abbrev = zipCodeState.get(i).getValue2();
    	  }
      ...
      for (i = 0; i < abbrevState.size(); ++i) {
         // TODO: Using state abbreviation, find state name
    	  if (abbrevState.get(i).getValue1().equals(abbrev)) {
    		  name = abbrevState.get(i).getValue2();
    	  }
      ...
      for (i = 0; i < statePopulation.size(); ++i) {
         // TODO: Using state name, find population. Print pair info.
    	  if (statePopulation.get(i).getValue1().equals(name)) {
    		  population = statePopulation.get(i).getValue2();
    	  }
      }
      
      StatePair<String, Integer> pair = new StatePair<String, Integer>(name, population);
      pair.printInfo();
   }
   }
